...
namespace CCL.MES.Infrastructure.Migrations
{
    ...
    [Migration("20260925024952_AddWoMaterialIpqcWaiver")]
    partial class AddWoMaterialIpqcWaiver
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.CheckItemDefectOption", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ItemId", "DefectCode", "ProductCode")
                        .IsUnique();

                    b.ToTable("CheckItemDefectOptions");
                });
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.IqcInspection", b =>
                {
                    ...
                    b.Property<string>("SampleSizeOverrideReason")
                        .HasMaxLength(512)
                        .HasColumnType("TEXT");

                    b.Property<int?>("SampleSizeSuggested")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.IqcMaterialDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("MaterialCode", "DocType")
                        .IsUnique();

                    b.ToTable("IqcMaterialDocuments");
                });
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.IqcNgRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("DetectedStage")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<double?>("NgAreaM2")
                        .HasColumnType("REAL");

                    b.Property<double?>("NgQty")
                        .HasColumnType("REAL");

                    b.Property<int?>("NgRolls")
                        .HasColumnType("INTEGER");

                    b.Property<string>("NgUom")
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.IqcResultDetail", b =>
                {
                    ...
                    b.Property<string>("AutoVerdict")
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");

                    b.Property<int?>("AutoVerdictOffendingSeq")
                        .HasColumnType("INTEGER");

                    b.Property<string>("AutoVerdictReason")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.IqcResultMeasurement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("IqcResultDetailId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("IqcResultDetailId", "Seq")
                        .IsUnique();

                    b.ToTable("IqcResultMeasurements");
                });
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.IqcSpecItem", b =>
                {
                    ...
                    b.Property<double?>("LimitNominal")
                        .HasColumnType("REAL");

                    b.Property<bool>("LimitParsed")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.QcCriterion", b =>
                {
                    ...
                    b.Property<string>("LibraryItemKey")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.RawMaterial", b =>
                {
                    ...
                    b.Property<string>("AccountingGroupDescription")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("DimensionQuality")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ProductFamilyDescription")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool?>("PermApproveProduction")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("PermApproveQc")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("PermEditData")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("PermExportReport")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("PermManageUsers")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("PermSpecialAccept")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("PermSystemConfig")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("PermViewData")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.WoIpqcCheckItem", b =>
                {
                    ...
                    b.Property<string>("CavitySource")
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<long?>("LimitSourceWindowId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.WoIpqcMaterialCheck", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("ActualLotNo")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("DivergenceApprovalStatus")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");

                    b.Property<int>("DivergenceFlags")
                        .HasColumnType("INTEGER");

                    b.Property<string>("DivergenceKind")
                        .IsRequired()
                        .HasMaxLength(24)
                        .HasColumnType("TEXT");

                    b.Property<string>("ExpectedPartNo")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");

                    b.Property<bool>("HasShadowFk")
                        .HasColumnType("INTEGER");

                    b.Property<string>("IqcResultSnapshot")
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("MaterialLotStatusSnapshot")
                        .HasMaxLength(32)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("SourceIqcReceiptNo")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("WoIpqcMaterialChecks");
                });
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.WoMaterial", b =>
                {
                    ...
                    b.Property<DateTime?>("IpqcWaiverAt")
                        .HasColumnType("TEXT");

                    b.Property<string>("IpqcWaiverBy")
                        .HasColumnType("TEXT");

                    b.Property<string>("IpqcWaiverLotNo")
                        .HasColumnType("TEXT");

                    b.Property<string>("IpqcWaiverLotStatus")
                        .HasColumnType("TEXT");

                    b.Property<string>("IpqcWaiverReason")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.WoPhaseSpan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("WoId")
                        ...
                        .HasFilter("\"EndedAt\" IS NULL AND \"WoLegId\" IS NULL");

                    b.HasIndex("WoLegId");

                    b.HasIndex("WoId", "Phase");

                    b.HasIndex("WoId", "StartedAt");

                    b.HasIndex("WoId", "WoLegId")
                        .IsUnique()
                        .HasDatabaseName("UX_WoPhaseSpans_OpenPerLeg")
                        .HasFilter("\"EndedAt\" IS NULL AND \"WoLegId\" IS NOT NULL");

                    b.ToTable("WoPhaseSpans");
                });
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.WoSettingCheckItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("WorkOrderId", "ProcessKind", "ItemKey")
                        .IsUnique();

                    b.ToTable("WoSettingCheckItems");
                });
            ...
            modelBuilder.Entity("CCL.MES.Domain.Entities.WoQcPhoto", b =>
                {
                    b.HasOne("CCL.MES.Domain.Entities.WoQcCheckItem", null)
                        .WithMany()
                        .HasForeignKey("WoQcCheckItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
