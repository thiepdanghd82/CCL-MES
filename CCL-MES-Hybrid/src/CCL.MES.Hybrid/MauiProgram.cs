...
public static class MauiProgram
{
    ...
    {
        // P10.6a hotfix — arm the global last-chance error trap BEFORE
        // any DI graph wiring. A throw during host build or DI
        // construction must still land in Console.WriteLine + the
        // rolling error log so an operator-side incident leaves a
        // forensic trail. See GlobalErrorLogger doc-comment for the
        // why (the "renderer dead after N seconds" symptom on Mac
        // Catalyst Hybrid that recurred after the P10.5g hardening
        // was reverted).
