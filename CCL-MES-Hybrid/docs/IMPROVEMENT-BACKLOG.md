...
| Việc | Ghi chú |
|---|---|
| `PrepressControllerTests.Concurrent_prepress_row_updates_N_equals_10_yield_consistent_rollup` **flake** | Đỏ trong full-suite, **xanh 3/3 khi chạy riêng** (2026-08-18). Đúng lớp L25 (soak SQLite-macOS). Cần cô lập fixture hoặc đánh `Category=Soak` tách khỏi CI chính — flake làm CI mất giá trị tín hiệu. |
